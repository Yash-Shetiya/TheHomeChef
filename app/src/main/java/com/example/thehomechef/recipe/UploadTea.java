...
public class UploadTea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileReference = FirebaseDatabase.getInstance().getReference("RecipesFile").child("tea").getRef();
                ...
                Dexter.withContext(getApplicationContext())
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                                Toast.makeText(UploadTea.this, "Please give permission to upload files", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void processupload(Uri filepath) {
        ...
        StorageReference reference = storageReference.child("recipes/").child("tea/"+System.currentTimeMillis()+".pdf");
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                pd.dismiss();
                                Toast.makeText(UploadTea.this, "Recipe added successfully.", Toast.LENGTH_SHORT).show();
                                filelogo.setVisibility(View.INVISIBLE);
                                filecancel.setVisibility(View.INVISIBLE);
                                filebrowse.setVisibility(View.VISIBLE);
                                filename.setText("");
