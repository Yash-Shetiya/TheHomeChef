...
public class savoryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<fileinfomodel> options =
                new FirebaseRecyclerOptions.Builder<fileinfomodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference("RecipesFile").child("savory").getRef(), fileinfomodel.class)
                        .build();
